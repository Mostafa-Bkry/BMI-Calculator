            ...
            children: [
                  ...
                  children: [
                    Expanded(
                      child: GestureDetector(
                        onTap: () => BMICubit.get(context).maleOrFemale('m'),
                        child: Card(
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          BMICubit.get(context).maleOrFemale('f');
                        },
                        child: Card(
                          clipBehavior: Clip.hardEdge,
                          margin: const EdgeInsets.symmetric(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Slider(
                          ...
                          min: 80,
                          onChanged: (value) {
                            BMICubit.get(context).sliderChange(value);
                            //print(value.round());
                          },
                            ...
                            Row(
                              ...
                              children: [
                                FloatingActionButton(
                                  ...
                                  onPressed: () =>
                                      BMICubit.get(context).weightDown(),
                                  heroTag: 'weight--',
                                  mini: true,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () => BMICubit.get(context).bmiResult(context),
                    child: const Text(
                      'Calculate',
                      style: TextStyle(
                        fontSize: 35,
